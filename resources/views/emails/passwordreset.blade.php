                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <h4>Password Reset Code:</h4>
                            <li style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 22px; line-height: 32px;">Code: {{ $password->token }}</li>
                            <br>
                            <br>
                            <span>Please reset your password with this code</span>
                           </font>
                        </td>
                     </tr>
                  </table>
