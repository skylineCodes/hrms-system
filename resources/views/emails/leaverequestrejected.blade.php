                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                              <p style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 22px; line-height: 32px;">Sorry, your leave request has been rejected!</p>

                              <p>Your leave request has been reviewed and duely declined. We are sorry if this might cause any inconvinience but the interest of the company is paramount</p>
                                 ...
                                 <tr>
                                    ...
                                    <td class="mob_center" align="left" valign="top">
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 19px; line-height: 23px;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;">{{ config('app.name') }} Administrator</span>
                                       </font>
                                    </td>
                                    <td width="18" style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;</td>
                                 </tr>
